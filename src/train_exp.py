...
def train_exp(batch_size=16, lr=0.001, num_epochs=2,dataset='cifar10'):
    """
    ...
    if dataset=='cifar10':
        ...
        metrics_dir = 'metrics/exp/cifar10/'
        num_classes=100
    elif dataset=='cifar100':
        trainset = torchvision.datasets.CIFAR100(root='./data', train=True,
                                            download=True, transform=transform)
        save_dir = 'checkpoints/exp/cifar100/'
        metrics_dir = 'metrics/exp/cifar100/'
        num_classes=100
...
if __name__ == '__main__':
    ...
    ep = int(args.epochs)
    train_exp(b,lr,ep,args.data_set)
